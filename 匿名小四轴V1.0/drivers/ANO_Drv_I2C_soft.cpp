...
void ANO_I2C_Soft::Init(void)
{
  ...
  RCC_APB2PeriphClockCmd(ANO_RCC_I2C , ENABLE );        //GPIOB
  GPIO_InitStructure.GPIO_Pin =  I2C_Pin_SCL;           //GPIOB10
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;     
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD;     
  GPIO_Init(ANO_GPIO_I2C, &GPIO_InitStructure);        //GPIOB

  GPIO_InitStructure.GPIO_Pin =  I2C_Pin_SDA;         //GPIOB11
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD;
